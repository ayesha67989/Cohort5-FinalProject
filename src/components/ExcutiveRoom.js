...
import ExecutiveRoomHeader from './ExecutiveRoomHeader'
import Footer from './Footer';

function ExcutiveRoom() {
  ...
  return (
    ...
    <button id="buttonRoom" onClick={classicClick}
    >Book Now</button>
<div id='fieldsetRoom'>
